...
# Dataset and State 
nameState = 'California'
#nameDataset = 'InputLSTM/California_Hospitalization_TDA.csv'
#nameDataset = 'InputLSTM/California_MR_TDA.csv'
#nameDataset = 'InputLSTM/California_IFR_TDA.csv'
nameDataset = 'InputLSTM/California_NewCases_TDA.csv'
# Train and test day 
...
# Location Variables (HOSPITALIZATION)
#locMAIN = [0, 56] # Main Variables
#locTDA = [57, 71] # TDA Variables
#locEV = [72, 83] # Environmental Variables
# Location Variables (OTHERS)
locMAIN = [0, 59] # Main Variables
locTDA = [60, 74] # TDA Variables
locEV = [75, 86] # Environmental Variables
